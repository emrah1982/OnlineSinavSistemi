using OnlineSinavCore.Exception.Abstract;
using System;
...
using System.Text;
namespace OnlineSinavCore.Exception.Concrete
{
    public class ExceptionHandling
    {
        ...
        public T SurroundWithTryCatch<T>(Func<T> func, MethodBase methodbase, IExceptionFormatter exceptionFormatter, string errorDesc = null, Action<System.Exception> failCallback = null, bool throwup = true)
        {
            try
            {
                return func();
        ...
        public void SurroundWithTryCatch(Action method, MethodBase methodbase, IExceptionFormatter exceptionFormatter, string errorDesc = null, Action<System.Exception> failCallback = null, bool throwup = true)
        {
            try
            {
                method();
        ...
        /// <param name="exceptionFormatter">Exceptionı handle edecek formatter.</param>
        /// <returns>Geriye içerisinde formatlanan hata olan hatayı Exception tipinde geriye döner</returns>
        /*private*/ public System.Exception ThrowErrorMini(MethodBase methodbase, string errorDesc, System.Exception ex, ExceptionTypes exType, IExceptionFormatter exceptionFormatter)
        {
